...
private:
   ...
   void densityFromAltitude_10000() ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   {
      ...
      // verify
      //cout << "*******************************************" << density;
      assertEquals(density, 0.4135000); // we get 0.5
   }
   ...
   void densityFromAltitude_80000() ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   {
      ...
      //cout << "*******************************************" << density;
      // verify
      assertEquals(density, closeEnough(0.0000185, 0.1)); // we get 0.0
   }
   ...
   void dragFromMach_000() /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   {
      ...
      // verify
      //cout << "*******************************************" << drag;
      assertEquals(drag, 0.1629); // we get 0.2
   }  // teardown
   ...
   void dragFromMach_500() /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   {
      ...
      //cout << "*******************************************" << drag;
      // verify
      assertEquals(drag, 0.2656); // we get 0.2
   }  // teardown
   ...
   void dragFromMach_100() /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   {
      ...
      //cout << "*******************************************" << drag;
      // verify
      assertEquals(drag, 0.4258); // we get 0.4
   }  // teardown
   ...
   void dragFromMach_060() /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   {
      ...
      //cout << "*******************************************" << drag;
      // verify
      assertEquals(drag, 0.1845); // we get 0.2
   }  // teardown
